  ...
  return (
    <div className="w-full">
      ...
      <section className="min-h-screen flex flex-col justify-center items-center bg-white text-gray-800 px-6 py-12">
        <h1 className="text-7xl md:text-9xl font-extrabold text-blue-800 mb-6 tracking-wide">
  ABHYUDAYA
</h1>
          ...
          {competitions.map((comp, index) => (
            ...
            >
              ...
              <p className="text-sm text-gray-600">
                Join {comp.title} and test your skills in an exciting competition.
              </p>
            </motion.div>
          ))}
        </div>
      ...
      <section className="min-h-screen w-full px-4 py-16 bg-white text-gray-800">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {[
            {
              name: "Aarav Sharma",
              feedback: "Participating in this event was an incredible experience.",
              image: "/testimonials/1.jpg"
            },
            {
              name: "Sneha Patel",
              feedback: "The competitions pushed me to think creatively. Loved it!",
              image: "/testimonials/2.jpg"
            },
            {
              name: "Rahul Mehta",
              feedback: "Truly an event to remember. I had so much fun.",
            ...
            <motion.div
              ...
              whileHover={{ scale: 1.05 }}
              className="bg-gray-100 rounded-xl p-6 shadow-md transition-all"
            >
      ...
      <section className="bg-white py-16 px-4 text-gray-800">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {[
            { year: "2021", title: "Inception", desc: "Promoting creativity and culture." },
            { year: "2022", title: "Intercollege Event", desc: "Welcomed colleges from Nagpur." },
            { year: "2023", title: "Tech + Cultural Merge", desc: "Expanded scope and outreach." },
            { year: "2024", title: "Mega Fest", desc: "1000+ attendees and media buzz." },
          ].map((item, index) => (
            <motion.div
              key={index}
